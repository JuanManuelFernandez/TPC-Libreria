<%@ Page Title="Agregar Autor" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AgregarAutor.aspx.cs" Inherits="Libreria.AgregarAutor" %>
    ...
    <div class="container my-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Agregar Autor</li>
            </ol>
        </nav>

        <h1 class="text-center">Agregar Autor
        </h1>
